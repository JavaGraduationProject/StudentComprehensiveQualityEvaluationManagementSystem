...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateJiangchengxinxi.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改奖惩信息<input type="hidden" name="id" value="${jiangchengxinxi.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.jiangchengbianhao.value='${jiangchengxinxi.jiangchengbianhao}';</script>	<script language="javascript">document.form1.jiangchengbiaoti.value='${jiangchengxinxi.jiangchengbiaoti}';</script>	<script language="javascript">document.form1.jiangchengneirong.value='${jiangchengxinxi.jiangchengneirong}';</script>	<script language="javascript">document.form1.jiangchengfenshu.value='${jiangchengxinxi.jiangchengfenshu}';</script>	<script language="javascript">document.form1.shijian.value='${jiangchengxinxi.shijian}';</script>	<script language="javascript">document.form1.lururen.value='${jiangchengxinxi.lururen}';</script>	
					 </table>
			</form>
   </body>
</html>
