...
function gows()
{
	document.location.href="nenglijiafen_add.jsp?id=<%=id%>";
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateNenglijiafen.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改能力加分<input type="hidden" name="id" value="${nenglijiafen.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xuehao.value='${nenglijiafen.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${nenglijiafen.xingming}';</script>	<script language="javascript">document.form1.banji.value='${nenglijiafen.banji}';</script>	<script language="javascript">document.form1.shifouguoyingyusiji.value='${nenglijiafen.shifouguoyingyusiji}';</script>	<script language="javascript">document.form1.shifouguoyingyuliuji.value='${nenglijiafen.shifouguoyingyuliuji}';</script>	<script language="javascript">document.form1.shifouqudejiaoshizigezheng.value='${nenglijiafen.shifouqudejiaoshizigezheng}';</script>	<script language="javascript">document.form1.shifouweiyingzhengruwufanxiaoxuexizhe.value='${nenglijiafen.shifouweiyingzhengruwufanxiaoxuexizhe}';</script>	<script language="javascript">document.form1.fuyiqijianshifouligong.value='${nenglijiafen.fuyiqijianshifouligong}';</script>	<script language="javascript">document.form1.qita.value='${nenglijiafen.qita}';</script>	<script language="javascript">document.form1.jiafenshu.value='${nenglijiafen.jiafenshu}';</script>	
					 </table>
			</form>
   </body>
</html>
