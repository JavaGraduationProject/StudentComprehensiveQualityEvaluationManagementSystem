...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">学生成绩列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="xueshengchengjiList2.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.xuehao}</td>    <td>${u.xingming}</td>    <td align='center' bgcolor='#ebf0f7'>${u.xingbie}</td>    <td>${u.banji}</td>    <td>${u.xuenian}</td>    <td>${u.xueqi}</td>    <td>${u.kemu}</td>    <td>${u.fenshu}</td>    
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateXueshengchengji.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteXueshengchengji.do?id=${u.id }"
		 ...
		 <%
			String sql="select * from xueshengchengji where xuehao='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		...
		共计分数:<%=fenshuz%>； 其中最高分数：<%=zgffenshu%>；最低分数：<%=zdffenshu%>；平均分数：<%out.print(Math.round(1000*(fenshuz/i))/1000.0);%>；
		 ...
		 <c:if test="${page.page>1}">
              <a href="xueshengchengjiList2.do?page=1" >首页</a>
             <a href="xueshengchengjiList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="xueshengchengjiList2.do?page=${page.page+1 }">下一页</a>
			<a href="xueshengchengjiList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
