...
<dl class="custom">
			...
			<dt onClick="changeImage()">奖惩管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="jiangchengxinxi_add.jsp" target="hsgmain">奖惩添加</a></dd><dd><a href="jiangchengxinxiList2.do" target="hsgmain">奖惩查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">学生成绩管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xueshengchengjiList2.do" target="hsgmain">学生成绩查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">能力加分管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="nenglijiafenList2.do" target="hsgmain">能力加分查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">综合测评管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="zonghecepingList2.do" target="hsgmain">综合测评查询</a></dd>
		</dl><dl class="custom">
			<dt onClick="changeImage()">留言板管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="liuyanban_add.jsp" target="hsgmain">留言板添加</a></dd><dd><a href="liuyanbanList2.do" target="hsgmain">留言板查询</a></dd>
		</dl>
