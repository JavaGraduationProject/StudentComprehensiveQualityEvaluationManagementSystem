...
<html xmlns="http://www.w3.org/1999/xhtml">
			  ...
			  <table width="100%" border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="zonghecepingListjs.do" name="myform" method="post">
    ...
    <td>${u.zonghedefen}</td>
                              ...
                              <td align="center"> <a class="btn btn-info btn-small" href="zonghecepingDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
...
while(RS_result.next()){
		...
		共计综合得分:<%=zonghedefenz%>； 其中最高综合得分：<%=zgfzonghedefen%>；最低综合得分：<%=zdfzonghedefen%>；平均综合得分：<%out.print(Math.round(1000*(zonghedefenz/i))/1000.0);%>；
		 ...
		 <c:if test="${page.page>1}">
              <a href="zonghecepingListjs.do?page=1" >首页</a>
             <a href="zonghecepingListjs.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="zonghecepingListjs.do?page=${page.page+1 }">下一页</a>
			<a href="zonghecepingListjs.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
