...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <td>${u.huifu}</td>
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateLiuyanbanlb.do?id=${u.id }">回复</a>  <a class="btn btn-info btn-small" href="liuyanbanDetail.do?id=${u.id}">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
