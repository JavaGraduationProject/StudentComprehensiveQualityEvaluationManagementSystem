				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td height="30" colspan="17" background="images/table_header.gif">综合测评列表</td>
						</tr>
					</table>
				</td>
			</tr>
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.xuehao}</td>    <td>${u.xingming}</td>    <td>${u.banji}</td>    <td>${u.jisuanchuxueshengcaoxingcepingfen}</td>    <td>${u.zhiyucepingdefen}</td>    <td>${u.nenglijiafenxiangdefen}</td>    <td>${u.zonghedefen}</td>    
                              ...
                              <td align="center"><a class="btn btn-info btn-small" href="doUpdateZongheceping.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteZongheceping.do?id=${u.id }"
