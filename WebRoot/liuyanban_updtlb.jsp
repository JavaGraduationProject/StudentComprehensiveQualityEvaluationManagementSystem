	...
	<body>
			<form action="updateLiuyanban.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.xuehao.value='${liuyanban.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${liuyanban.xingming}';</script>	<script language="javascript">document.form1.banji.value='${liuyanban.banji}';</script>	<script language="javascript">document.form1.liuyanneirong.value='${liuyanban.liuyanneirong}';</script>	<script language="javascript">document.form1.huifu.value='${liuyanban.huifu}';</script>	
					 </table>
			</form>
   </body>
</html>
