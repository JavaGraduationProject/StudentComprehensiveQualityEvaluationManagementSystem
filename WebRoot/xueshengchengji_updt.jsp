...
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="updateXueshengchengji.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">修改学生成绩<input type="hidden" name="id" value="${xueshengchengji.id}" /></td>
						</tr>
						...
						<script language="javascript">document.form1.xuehao.value='${xueshengchengji.xuehao}';</script>	<script language="javascript">document.form1.xingming.value='${xueshengchengji.xingming}';</script>	<script language="javascript">document.form1.xingbie.value='${xueshengchengji.xingbie}';</script>	<script language="javascript">document.form1.banji.value='${xueshengchengji.banji}';</script>	<script language="javascript">document.form1.xuenian.value='${xueshengchengji.xuenian}';</script>	<script language="javascript">document.form1.xueqi.value='${xueshengchengji.xueqi}';</script>	<script language="javascript">document.form1.kemu.value='${xueshengchengji.kemu}';</script>	<script language="javascript">document.form1.fenshu.value='${xueshengchengji.fenshu}';</script>	
					 </table>
			</form>
   </body>
</html>
