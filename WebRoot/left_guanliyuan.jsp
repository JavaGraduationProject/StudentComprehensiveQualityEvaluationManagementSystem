...
<dl class="custom">
			...
			<dd><a href="xueshengxinxi_add.jsp" target="hsgmain">学生添加</a></dd>
...
<dl class="custom">
			...
			<dd><a href="jiaoshixinxi_add.jsp" target="hsgmain">教师添加</a></dd>
<dd><a href="jiaoshixinxiList.do" target="hsgmain">教师查询</a></dd>

		</dl>

<dl class="custom">
			<dt onClick="changeImage()">学生成绩管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="xueshengchengji_add.jsp" target="hsgmain">学生成绩添加</a></dd>
<dd><a href="xueshengchengjiList.do" target="hsgmain">学生成绩查询</a></dd>

		</dl>

<dl class="custom">
			<dt onClick="changeImage()">综合测评管理<img src="images/left/select_xl01.png"></dt>
			<dd><a href="zongheceping_add.jsp" target="hsgmain">综合测评添加</a></dd>
<dd><a href="zonghecepingList.do" target="hsgmain">综合测评查询</a></dd>
