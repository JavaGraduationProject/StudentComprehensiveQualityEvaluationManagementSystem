				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.xuehao}</td>    <td>${u.xingming}</td>    <td>${u.banji}</td>    <td>${u.liuyanneirong}</td>    <td>${u.huifu}</td>    
                              ...
                              <td height="45" align="center"><a class="btn btn-info btn-small" href="doUpdateLiuyanban.do?id=${u.id }">编辑</a>  <a class="btn btn-info btn-small" href="deleteLiuyanban.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a class="btn btn-info btn-small" href="liuyanbanDetail.do?id=${u.id }">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
