...
function gows()
{
	document.location.href="zongheceping_add.jsp?id=<%=id%>&xuehao="+document.form1.xuehao.value;
}
function hsgxia2shxurxu(nstr,nwbk)
{
	...
	<body>
			<form action="addZongheceping.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						<tr bgcolor="#E7E7E7">
							<td height="30" colspan="2" background="images/table_header.gif">添加综合测评</td>
						</tr>
...
%>
<script language="javascript">
document.form1.xuehao.value="<%=connDbBean.readzd("xueshengxinxi","xuehao","xuehao",request.getParameter("xuehao"))%>";document.form1.xingming.value="<%=connDbBean.readzd("xueshengxinxi","xingming","xuehao",request.getParameter("xuehao"))%>";document.form1.banji.value="<%=connDbBean.readzd("xueshengxinxi","banji","xuehao",request.getParameter("xuehao"))%>";document.form1.jisuanchuxueshengcaoxingcepingfen.value="<%=connDbBean.readzd("xueshengxinxi","jisuanchuxueshengcaoxingcepingfen","xuehao",request.getParameter("xuehao"))%>";document.form1.zhiyucepingdefen.value="<%=connDbBean.readzd("xueshengxinxi","zhiyucepingdefen","xuehao",request.getParameter("xuehao"))%>";document.form1.nenglijiafenxiangdefen.value="<%=connDbBean.readzd("xueshengxinxi","nenglijiafenxiangdefen","xuehao",request.getParameter("xuehao"))%>";
